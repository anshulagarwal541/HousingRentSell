    ...
    return (
        <AuthContext.Provider value={{ setHouses, setAlert, setAlertMessage, setAlertType, url }}>
            <div className='bg-[#ffe0ce] py-5'>
                <p className='text-2xl font-bold flex justify-center items-center'>Property Sell/Buy Section</p>
                <div className='flex justify-center items-center gap-5 py-5'>
                    <button onClick={() => { handleClick("pending") }} className={`${button == "pending" ? "bg-white text-red-500 border-2 border-red-500" : "bg-red-500 text-white"} font-bold text-2xl rounded-xl px-5 py-2`}>Unsold</button>
                    <button onClick={() => { handleClick("waiting") }} className={`${button == "waiting" ? "bg-white text-orange-300 border-2 border-orange-300" : "bg-orange-300 text-white"} font-bold text-2xl rounded-xl px-5 py-2`}>Requests</button>
                    ...
                    <button onClick={() => { handleClick("rejected") }} className={`${button == "rejected" ? "bg-white text-red-500 border-2 border-red-500" : "bg-red-500 text-white"} font-bold text-2xl rounded-xl px-5 py-2`}>Rejected</button>
                    <button onClick={() => { handleClick("bought") }} className={`${button == "bought" ? "bg-white text-green-950 border-2 border-green-950" : "bg-green-950 text-white"} font-bold text-2xl rounded-xl px-5 py-2`}>Bought</button>
                </div>
                <div className=''>
